		...
		<script>
			...
			$(function() {
				...
				$("#btn_confirm_data_change").click(function(){
					var f = document.createElement("form");
					f.setAttribute('method',"post");
					f.setAttribute('action',"/setting_notification_update");
					<%
					for(Map.Entry<String,String[]>e:paramsMap.entrySet()){
					%>
					f.appendChild(setParam('<%=e.getKey()%>','<%=((String[])e.getValue())[0]%>'));
	...
	<body>
      ...
      <section class="container grid-1280">
				...
				<table class="app_mail_table_layout">
					<tbody>
						<tr>
							...
							<td>
								<span id="span_start_date"></span> ~ <span id="span_end_date"></span>
							</td>						
						</tr>
						<tr>
		...
		<div id="footer_go_to_confirmation">
			...
			<div><a class="confirm_data_btn  btn btn-lg  btn-primary" id="btn_confirm_data_change">　更新　</a></div>
