...
<%
  ...
  if (cookies != null) {
     for (Cookie cookie : cookies) {
      ...
      String accessTrainCompany  = trainCompanyStrGetter.getTrainCompanyStrWithArray((String)request.getParameter("app_access_train_company"));//"app_access_train_company"
      String accessTrainLine   = routeStrGetter.getRouteStrWithArray((String)request.getParameter("app_access_train_line"));//app_access_train_line
 ...
 <head>
  ...
  <script>
			...
			function back(){
				...
				f.setAttribute('action',"/setting_store_create");                                         
				<%
			...
			function sendConfirmedData() {			
					...
					var f = document.createElement("form");
                    f.setAttribute('method',"post");
                    f.setAttribute('action',"/setting_store_submit");                  
   ...
   <div class="content-wrapper">
    <section class="content-header">
     ...
     <ol class="breadcrumb">
      ...
      <li><a href="/setting_store"><i class="fa fa-cogs"></i> ト設定</a></li>
         ...
         <div class="box box-kujira">
          ...
          <div class="box-body">
           <div class="form-group">
            ...
            <div class="col-lg-10 col-sm-10 col-xs-12">
             <span style="font-size: 12px;" id="div_store_manager"></span>
            </div>
           </div>
          </div>
          <div class="box-body" style="background-color: rgb(238, 120, 0, 0.2)">
           <div class="form-group">
            ...
            <div class="col-lg-10 col-sm-10 col-xs-12">
             <span style="font-size: 12px;" id="div_store_group"></span>
            </div>
           </div>
          </div>
          <div class="box-body">
       ...
       <div class="row">
        <div class="col-md-12 col-xs-12">
         <div id="footer_go_to_confirmation">
          <div class="pull-left">
           <a class="btn btn-warning" style="font-size: 12px;" id="btn_back" onClick="back()">< 戻る</a>
          </div>
